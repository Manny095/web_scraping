...
@app.route('/scrape_flip_iphone_cheapest')
...
def m():
    ...
    my_url = "https://www.flipkart.com/search?sid=tyy%2C4io&otracker=CLP_Filters&p%5B%5D=facets.serviceability%5B%5D%3Dfalse&p%5B%5D=facets.brand%255B%255D%3DApple&sort=popularity"
